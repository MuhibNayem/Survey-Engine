...
public class RegisterRequest {
  ...
  public RegisterRequest fullName(@javax.annotation.Nonnull String fullName) {
  ...
  public RegisterRequest confirmPassword(@javax.annotation.Nonnull String confirmPassword) {
  ...
  public RegisterRequest tenantId(@javax.annotation.Nullable String tenantId) {
   ...
   * @return the RegisterRequest instance itself
   */
  public RegisterRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fullName, registerRequest.fullName) &&
        Objects.equals(this.email, registerRequest.email) &&
        Objects.equals(this.password, registerRequest.password) &&
        Objects.equals(this.confirmPassword, registerRequest.confirmPassword) &&
        Objects.equals(this.tenantId, registerRequest.tenantId)&&
        Objects.equals(this.additionalProperties, registerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fullName, email, password, confirmPassword, tenantId, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fullName", "email", "password", "confirmPassword", "tenantId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fullName", "email", "password", "confirmPassword"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("confirmPassword").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `confirmPassword` to be a primitive type in the JSON string but got `%s`", jsonObj.get("confirmPassword").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RegisterRequest>() {
           ...
           public RegisterRequest read(JsonReader in) throws IOException {
             ...
             RegisterRequest instance = thisAdapter.fromJsonTree(jsonObj);
