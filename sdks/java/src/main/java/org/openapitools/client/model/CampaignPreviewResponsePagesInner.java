...
public class CampaignPreviewResponsePagesInner {
  ...
  public CampaignPreviewResponsePagesInner id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public CampaignPreviewResponsePagesInner title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public CampaignPreviewResponsePagesInner sortOrder(@javax.annotation.Nullable Integer sortOrder) {
   ...
   * @return the CampaignPreviewResponsePagesInner instance itself
   */
  public CampaignPreviewResponsePagesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignPreviewResponsePagesInner campaignPreviewResponsePagesInner = (CampaignPreviewResponsePagesInner) o;
  ...
  public String toString() {
    ...
    sb.append("class CampaignPreviewResponsePagesInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CampaignPreviewResponsePagesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignPreviewResponsePagesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CampaignPreviewResponsePagesInner is not found in the empty JSON string", CampaignPreviewResponsePagesInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignPreviewResponsePagesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignPreviewResponsePagesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignPreviewResponsePagesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignPreviewResponsePagesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignPreviewResponsePagesInner>() {
           @Override
           public void write(JsonWriter out, CampaignPreviewResponsePagesInner value) throws IOException {
           ...
           @Override
           public CampaignPreviewResponsePagesInner read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CampaignPreviewResponsePagesInner instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CampaignPreviewResponsePagesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CampaignPreviewResponsePagesInner
   * @throws IOException if the JSON string is invalid with respect to CampaignPreviewResponsePagesInner
   */
  public static CampaignPreviewResponsePagesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignPreviewResponsePagesInner.class);
  }

  /**
   * Convert an instance of CampaignPreviewResponsePagesInner to an JSON string
   *
   * @return JSON string
   */
