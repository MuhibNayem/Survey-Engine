...
class CampaignPreviewResponse(BaseModel):
    ...
    survey_title: Optional[StrictStr] = Field(default=None, alias="surveyTitle")
    survey_description: Optional[StrictStr] = Field(default=None, alias="surveyDescription")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "surveyTitle": obj.get("surveyTitle"),
            "surveyDescription": obj.get("surveyDescription"),
