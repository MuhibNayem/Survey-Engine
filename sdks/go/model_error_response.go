...
type ErrorResponse struct {
	...
	FieldErrors []ErrorResponseFieldErrorsInner `json:"fieldErrors,omitempty"`
...
func (o *ErrorResponse) GetFieldErrors() []ErrorResponseFieldErrorsInner {
	if o == nil || IsNil(o.FieldErrors) {
		var ret []ErrorResponseFieldErrorsInner
		return ret
	}
...
// SetFieldErrors gets a reference to the given []ErrorResponseFieldErrorsInner and assigns it to the FieldErrors field.
...
func (o *ErrorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ErrorResponse(varErrorResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "fieldErrors")
