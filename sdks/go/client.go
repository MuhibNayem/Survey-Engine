...
// APIClient manages communication with the Survey Engine MVP API API v1.1.0
...
type APIClient struct {
	...
	AdminAuthenticationAPI *AdminAuthenticationAPIService

	AuditLogsAPI *AuditLogsAPIService

	AuthProfilesAPI *AuthProfilesAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AdminAuthenticationAPI = (*AdminAuthenticationAPIService)(&c.common)
