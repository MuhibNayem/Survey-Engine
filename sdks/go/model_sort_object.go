...
func (o *SortObject) UnmarshalJSON(data []byte) (err error) {
	varSortObject := _SortObject{}

	err = json.Unmarshal(data, &varSortObject)

	if err != nil {
		return err
	}

	*o = SortObject(varSortObject)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "empty")
		delete(additionalProperties, "sorted")
		delete(additionalProperties, "unsorted")
