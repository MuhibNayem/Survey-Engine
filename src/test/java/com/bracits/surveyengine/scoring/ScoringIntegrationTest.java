...
class ScoringIntegrationTest {
                ...
                .pages(List.of(SurveyPageRequest.builder()
                        ...
                        .questions(List.of(
                                SurveyQuestionRequest.builder()
                                        .questionId(q1.getId()).sortOrder(1).mandatory(true).build(),
                                SurveyQuestionRequest.builder()
                                        .questionId(q2.getId()).sortOrder(2).mandatory(true).build()))
                        .build()))
                .build());
    ...
    void shouldRejectWeightSumNot100() {
        WeightProfileResponse profile = weightProfileService.create(WeightProfileRequest.builder()
        ...
        assertThatThrownBy(() -> weightProfileService.validateWeightSum(profile.getId()))
