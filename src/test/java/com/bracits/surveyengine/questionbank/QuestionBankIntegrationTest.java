...
class QuestionBankIntegrationTest {
    ...
    void shouldCreateQuestionWithInitialVersion() {
        ...
        QuestionVersion version = questionService.getLatestVersion(response.getId());
        assertThat(version.getVersionNumber()).isEqualTo(1);
        assertThat(version.getText()).isEqualTo("How satisfied are you?");
    }
    ...
    void shouldCreateNewVersionOnUpdate() {
        ...
        QuestionVersion v1 = questionService.getLatestVersion(created.getId());
        assertThat(v1.getVersionNumber()).isEqualTo(2);
    }
